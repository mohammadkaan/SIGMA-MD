...
global.owner = process.env.OWNER_NUMBER  || '94768967587' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://cpjoker:cpjoker553@cluster0.z9jjdxt.mongodb.net/" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "94768967587" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"𝚩𝐋𝚫𝐂𝐊 𝚸𝚫𝚴𝚻𝚮𝚵𝚪",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://chat.whatsapp.com/Fd9HOXWnwYh4LKKT0NgTSM' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/accb1cf34eefeffe3d95d.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '23_05_2024_SIGMA_MD_hh3UCjrA_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '𝚩𝐋𝚫𝐂𝐊 𝚸𝚫𝚴𝚻𝚮𝚵𝚪 𝚳𝐃',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ˢᴸᴹ(•ิ‿•ิ)𝑨𝒔𝒓𝒊`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ˢᴸᴹ(•ิ‿•ิ)',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "ˢᴸᴹ" ,          // ADD YOUR STICKER PACKNAME
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||"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" ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
